...
from .lib.tcpmtproxy import ConnectionTcpMTProxyRandomizedIntermediate


class ConnectionTcpMTProxyFakeTLS(ConnectionTcpMTProxyRandomizedIntermediate):
    def __init__(self,dc_id, *, loggers, proxy=None, local_addr=None):
        ...
        super().__init__(dc_id, loggers=loggers, proxy=proxy, local_addr=local_addr)
